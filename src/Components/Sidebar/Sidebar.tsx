...
const Sidebar = () => {
  return (
    <aside className="w-full lg:w-22 bg-[#f3f3f3] flex lg:flex-col px-3 py-5 lg:px-6 lg:py-10 rounded-full justify-between">
      ...
      <ul className="flex lg:flex-col gap-1 lg:gap-2">
        <li>
          <button className="size-10 flex items-center justify-center">
            <House className="text-[#4d4849]" />
          </button>
        </li>
        <li>
          <button className="size-10 flex items-center justify-center">
            <History className="size-6 text-[#bfbdbd] hover:text-[#4d4849] cursor-pointer transition-colors duration-250" />
          </button>
        </li>
        <li>
          <button className="size-10 flex items-center justify-center">
            <Compass className="size-6 text-[#bfbdbd] hover:text-[#4d4849] cursor-pointer transition-colors duration-250" />
          </button>
        </li>
      </ul>
